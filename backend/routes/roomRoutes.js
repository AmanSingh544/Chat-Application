...
router.get('/list', async (req, res) => {
    if(!req.user || !req.user._id){
        console.log('User not found in request (req.user is undefined)');
...
router.get('/available_room', async (req, res) => {
    ...
    try {
        // Find rooms where currentUserId is NOT in the `members` array
